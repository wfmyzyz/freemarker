...
public class SwaggerConfig {
    ...
    public Docket baseApi() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("模板接口").apiInfo(baseInfo()).select().apis(RequestHandlerSelectors.basePackage("${packageName}"))
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("API管理接口").apiInfo(apiInfo()).select().apis(RequestHandlerSelectors.basePackage("${packageName}"))
    ...
    public Docket backApi() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("后台管理接口").apiInfo(backInfo()).select().apis(RequestHandlerSelectors.basePackage("${packageName}"))
